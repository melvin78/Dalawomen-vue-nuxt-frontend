      ...
      <v-row align="center" justify="center">
        <v-col cols="10">
          <v-row justify="center">
            <v-col cols="12" sm="5">
              <h1 class="font-weight-light display-1" style="color: black">Email</h1>
              <h3 class="font-weight-light mt-3" style="color: black">
          melvin11665@gmail.com
              </h3>
              <h3 class="font-weight-light mt-3" style="color: black">
              ...
              <h3 class="font-weight-light" style="color: black">
...
import QueryForm from "@/components/landingpage/QueryForm";
export default {
  name:'ContactSection',
